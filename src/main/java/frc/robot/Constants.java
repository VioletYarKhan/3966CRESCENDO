...
{
  public static final double ROBOT_MASS = 90 / 2.205;
  public static final Matter CHASSIS    = new Matter(new Translation3d(0, 0, Units.inchesToMeters(13.5)), ROBOT_MASS);
  ...
  public static class VisionConstants {
        public static final String kCameraName = "PhotonCamera3966.1";
