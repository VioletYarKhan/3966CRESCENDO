...
public class aimShoot{
   ...
   * @param inputAngle The angle for the arm to move to before firing
   * 
   * Moves arm to inputAngle while spinning flywheels up, then shoot once arm is within setpoint tolerance and flywheels are spun up
   */
